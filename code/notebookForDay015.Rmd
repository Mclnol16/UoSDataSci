...
If your data contains questionable values (note that you have to carefully determine what constitutes a questionable value and you should be as transparent as possible about how you do this) for one of more variables, you essentially have two options:

1. Remove the observations (rows) that contain the questionable values. 

2. Replace the questionable values with NA. This is the preferred appraoch. 
