...
Often, a variable either follows or can be approximated by a known distribution. We will pick up here next time and then go on to consider missing values and covariation. 